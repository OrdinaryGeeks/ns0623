...
public class Test2Checkout {
	...
	assertTrue(pos.SaveUserInput.SaveToolCode("LADW"));
	...
	public void validRentalDays() {
		assertTrue(pos.SaveUserInput.SaveRentalDays(3));
	}
	
	@Test
	public void validDiscount() {
		assertFalse(pos.SaveUserInput.SaveDiscountPercent(10));
	}
